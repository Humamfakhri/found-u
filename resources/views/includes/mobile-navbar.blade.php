<nav class="mobile-navbar w-100 bg-white justify-content-around d-md-none py-3">
    <div class="d-flex justify-content-around align-items-center">
        <a href='/dashboard' data-bs-toggle="tooltip" data-bs-title="Dashboard"
            class="{{ Illuminate\Support\Str::contains(url()->current(), ['dashboard']) ? 'active' : '' }} d-flex align-items-center text-decoration-none">
            <i class='fa-solid fa-house fs-5'></i>
        </a>
        <a href='/postingan' data-bs-toggle="tooltip" data-bs-title="Postingan"
            class="{{ Illuminate\Support\Str::contains(url()->current(), ['postingan']) ? 'active' : '' }} d-flex align-items-center text-decoration-none">
            <i class='fa-solid fa-layer-group fs-5'></i>
        </a>
        <a href='/masukan' data-bs-toggle="tooltip" data-bs-title="Masukan"
            class="{{ Illuminate\Support\Str::contains(url()->current(), ['masukan']) ? 'active' : '' }} d-flex align-items-center text-decoration-none">
            <i class='fa-solid fa-comment-dots fs-5'></i>
        </a>
        <a href='/faq' data-bs-toggle="tooltip" data-bs-title="FAQ"
            class="{{ Illuminate\Support\Str::contains(url()->current(), ['faq']) ? 'active' : '' }} d-flex align-items-center text-decoration-none">
